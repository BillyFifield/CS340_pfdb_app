...
CREATE TABLE `Players_Games_Stats` (
  ...
  `passing_yard_total` int(11) DEFAULT 0,
  `passing_td_total` int(11) DEFAULT 0,
  `rushing_yard_total` int(11) DEFAULT 0,
  `rushing_td_total` int(11) DEFAULT 0,
  `receiving_yard_total` int(11) DEFAULT 0,
  `receiving_td_total` int(11) DEFAULT 0,
...
CREATE TABLE `Seasons` (
  `season_year` int(11) NOT NULL,
  `super_bowl_champ` int(11) NOT NULL,
  `super_bowl_runner_up` int(11) NOT NULL,
